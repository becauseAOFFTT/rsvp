import svgPaths from "../../imports/Mobile/svg-61rifmbnww";
import imgImage1 from "../../imports/Mobile/3ee240c14c16fce454428d4ef9d07ff317ac8a95.png";
...
export default function CoverMobile({ onOpen }: Props) {
  return (
    <div className="bg-white relative size-full" data-name="Mobile">
      <div className="absolute aspect-[679.860824192594/983.9515976357807] bottom-[-84px] flex items-center justify-center left-[-138.85px] top-[-25.95px]" style={{ containerType: "size" }}>
        <div className="flex-none h-[hypot(6.24373cqw,97.1225cqh)] rotate-[-2.54deg] w-[hypot(93.7563cqw,-2.87751cqh)]">
          <div className="relative size-full" data-name="image 1">
            <img alt="Chonratid & Artitaya" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1} />
          </div>
        </div>
      </div>
      <AcWeddingLogo />
      ...
      <button
        onClick={onOpen}
        className="-translate-x-1/2 absolute bottom-[25px] content-stretch flex h-[39px] items-center justify-center left-1/2 rounded-[999px] w-[232px] cursor-pointer"
        style={{ backgroundImage: "linear-gradient(140.72deg, rgb(62, 0, 0) 12.507%, rgb(201, 169, 110) 146.53%)" }}
      >
